...
Fig.: Visualization of fused pre- and post-operative CT plus overlay of masks after processing. Soft-tissue changes remain between two timepoints (6 years appart) after bone-focused registration. Medial region masks (green, yellow) in both eyes show an increase of volume (post-op relative to pre-op). Small apparent changes in lateral masks. This is confirmed by the reported volume change ratios, medial (l/r): 1.72/1.76, lateral (l/r): 1.03/1.01.
